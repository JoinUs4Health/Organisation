...
### Security Standards
When developing and providing our platform, we already take security aspects into account in advance (Privacy by Design).

The use of our platform is only possible via TLS-encrypted channels.
...
Below, we inform you of the collection of personal data when using our platform.
...
The following data is transmitted when sending e-mails:
...
### Use of our platform
#### Use without registration and login
When you merely use the platform for informational purposes, i.e. if you do not register or otherwise provide information to us, we only collect the personal data that your browser transmits to our server.
...
If you wish to view our platform, we collect the following data which is technically necessary for us to display our internet presence to you and to ensure its stability and security (here, the legal basis is Article 6 (1) (f) GDPR):

- IP address
- Browser type and browser version
- Operating system used and its version and, if applicable, interface
- Referrer URL (website from which you came to our platform)
...
#### Use with registration or login
If you register on our platform in order to be able to contribute to the project, we will collect the following data with your consent in addition to the above information to enable you to use it (the legal basis is Article 6 (1) (a) GDPR):

- Username (feel free to use a pseudonym)
- Password
- E-mail-address

you can optionally provide further information on the following topics in your profile:

- Main language (DE, EN, NL, PL)
...
##### E-mail address
An e-mail address is required from you so that we can confirm your account, inform you about activities in the groups you have chosen and to send you a new password.

##### Passwords
Passwords are always stored according to the security standards.
Before the password is stored in the database, it is changed using mathematical methods so that it cannot be read by us (hashed, salted).
This ensures that even in the event of a successful attack, no passwords can fall into the wrong hands.  
...
You can configure your browser settings according to your wishes and, for example, refuse the setting of certain or all cookies.
...
Reading out information is only possible on the domain where this data was also written.
...
### More features and offerings on our platform
In addition to the purely informational use of our platform, we offer various services that you can use if you are interested.
...
If personal data is transferred to a third country or to an international organisation, you have the right to be informed of the appropriate safeguards under Article 46 of the GDPR in connection with the transfer.
